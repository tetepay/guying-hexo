...
```html
<a href="https://blog.guyinga.top/" rel="external nofollow">孤影小站-あ布鸢尾绽放</a>
```
...
```code
a(href='https://blog.guyinga.top/' rel="external nofollow") 孤影小站-あ布鸢尾绽放
```
...
<div id="friendlink_checkboxs" style="padding: 0px 0px 0px 1.6rem;">
  <p>
    <label class="checkbox"><input type="checkbox" id="checkbox1" onclick="checkForm()">我已添加 <b>孤影小站</b> 博客的友情链接</label>
  </p>
  <p>
